...
@Service("merchantAuthAccount")
@Slf4j
public class MerchantAuthAccountService extends BaseAuthAccountService implements IAuthAccountService {

    @Resource(name = "merchantPassportService")
