...
@Service("consumerAuthAccount")
@Slf4j
public class ConsumerAuthAccountService extends BaseAuthAccountService implements IAuthAccountService {

    @Resource(name = "consumerPassportService")
