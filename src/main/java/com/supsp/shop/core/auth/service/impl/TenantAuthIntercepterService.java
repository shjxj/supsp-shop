...
@Service("tenantAuthIntercepter")
@Slf4j
public class TenantAuthIntercepterService extends BaseAuthIntercepterService implements IAuthIntercepterService {

    @Resource(name = "tenantAuthAccount")
