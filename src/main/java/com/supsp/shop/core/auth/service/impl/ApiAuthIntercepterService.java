...
@Service("apiAuthIntercepter")
@Slf4j
public class ApiAuthIntercepterService extends BaseAuthIntercepterService implements IAuthIntercepterService {

    @Resource(name = "apiAuthAccount")
