...
@Service("merchantAuthIntercepter")
@Slf4j
public class MerchantAuthIntercepterService extends BaseAuthIntercepterService implements IAuthIntercepterService {

    @Resource(name = "merchantAuthAccount")
