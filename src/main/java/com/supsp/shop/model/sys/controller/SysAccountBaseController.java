...
import com.supsp.shop.model.sys.params.SysAccount.SysAccountRequest;
 ...
 */
@RestController
public abstract class SysAccountBaseController extends BaseModelController<SysAccountModel, SysAccountServiceImpl, SysAccountMapper, SysAccount> {

    @Resource
    protected ISysAccountActionService sysAccountActionService;
    ...
    public ActionResult create(
            ...
            @Validated({ValidGroup.Insert.class}) @RequestBody SysAccount data
    ) throws ModelException {
    ...
    public ActionResult edit(
            ...
            @Parameter(description = "数据", name = "data")
            @Validated({ValidGroup.Update.class}) @RequestBody SysAccount data
    ) throws ModelException {
    ...
    public PagerData<SysAccount> list(
            @Parameter(description = "查询信息", name = "entityRequest")
            @Nullable @RequestBody SysAccountRequest entityRequest
    ) throws ModelException {
