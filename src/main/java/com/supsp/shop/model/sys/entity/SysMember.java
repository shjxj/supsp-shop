...
@Schema(name = "SysMember", description = "用户")
@DBEntity()
@SensitiveData
public class SysMember extends BaseModelEntity<SysMember> {
    ...
    @Schema(title = "商户ID", accessMode = Schema.AccessMode.READ_ONLY)
    @TableField(value = "merchant_id", insertStrategy = FieldStrategy.NOT_NULL, updateStrategy = FieldStrategy.NEVER)
    @EntityColumn(select = true, defaultSelect = true)
