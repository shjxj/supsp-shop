...
import com.supsp.shop.model.sys.params.SysMember.SysMemberFilter;
import com.supsp.shop.model.sys.params.SysMember.SysMemberParams;
...
public class SysMemberModel
        extends BaseEntityModel<SysMemberServiceImpl, SysMemberMapper, SysMember>
        implements IEntityModel<SysMemberServiceImpl, SysMemberMapper, SysMember> {
    ...
    public long countByName(
        ...
        QueryWrapper<SysMember> queryWrapper = this.getQueryWrapper();
//        if (hasColumn("member_name")) {
//            queryWrapper.eq("member_name", name);
//        }
            queryWrapper.eq("member_name", name);
        if (id > 0) {
            queryWrapper.ne(SysMember.MEMBER_ID, id);
        }
...
//        data.setIsSystem(null);
    ...
    public ActionResult edit( 
        ...
        QueryWrapper<SysMember> queryWrapper = this.getQueryWrapper();
        queryWrapper.eq(SysMember.MEMBER_ID, id);
        SysMember entity = this.service.getOne(queryWrapper);
        if (entity == null) {
...
//        }
        ...
        UpdateWrapper<SysMember> updateWrapper = this.getUpdateWrapper();
        updateWrapper.eq(SysMember.MEMBER_ID, id);
...
//        return ActionResult.success(true);
    ...
    @Cacher
    @Override
    public SysMember detail(long id) throws ModelException {
        if (CommonUtils.isNotID(id)) {
            throw new ModelException(ExceptionCodes.PARAMS_EMPTY);
        }
     ...
     */
    @Override
    public void wrapperKeyword(QueryWrapper<SysMember> wrapper, @Nullable IEntityParams<SysMember> params) {
    ...
    @Cacher
    @Override
    public <R extends BaseEntityRequest<? extends BaseEntityParams<SysMember>, ? extends BaseEntityFilter<SysMember>, SysMember>> QueryWrapper<SysMember> queryWrapper(
                @Nullable R entityRequest
    ) {
        QueryWrapper<SysMember> queryWrapper = this.getQueryWrapper();
        // params
        SysMemberParams params = entityRequest != null ? ((SysMemberParams) entityRequest.getParams()) : null;
        if (params != null) {
        ...
        // filter
        SysMemberFilter filter = entityRequest != null ? ((SysMemberFilter) entityRequest.getFilter()) : null;
        if (filter != null) {
    ...
    @Cacher
    @Override
    public <R extends BaseEntityRequest<? extends BaseEntityParams<SysMember>, ? extends BaseEntityFilter<SysMember>, SysMember>> PagerData<SysMember> queryList(
                @Nullable R entityRequest
    ) throws ModelException {
    ...
    @Cacher
    @Override
    public <R extends BaseEntityRequest<? extends BaseEntityParams<SysMember>, ? extends BaseEntityFilter<SysMember>, SysMember>> List<SysMember> query( 
                @Nullable R entityRequest
    ) throws ModelException {
    ...
    public ActionResult batchSetEnableStatus( 
        ...
        UpdateWrapper<SysMember> updateWrapper = this.getUpdateWrapper();
        updateWrapper.in(SysMember.MEMBER_ID, idList);
...
//        }
    ...
    public ActionResult batchDelete( 
        ...
        QueryWrapper<SysMember> queryWrapper = this.getQueryWrapper();
        queryWrapper.in(SysMember.MEMBER_ID, idList);
    ...
    public ActionResult batchSetOrder( 
        ...
        for (Map.Entry<Long, Integer> entry : data.entrySet()) {
            ...
            UpdateWrapper<SysMember> updateWrapper = this.getUpdateWrapper();
            updateWrapper.eq(SysMember.MEMBER_ID, entry.getKey());
