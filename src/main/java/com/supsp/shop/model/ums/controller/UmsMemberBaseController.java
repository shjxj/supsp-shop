 ...
 */
@RestController
public abstract class UmsMemberBaseController extends BaseModelController<UmsMemberModel, UmsMemberServiceImpl, UmsMemberMapper, UmsMember> {

    @Resource
    protected IUmsMemberActionService umsMemberActionService;
    ...
    public ActionResult create(
            ...
            @Validated({ValidGroup.Insert.class}) @RequestBody UmsMember data
    ) throws ModelException {
    ...
    public ActionResult edit(
            ...
            @Parameter(description = "数据", name = "data")
            @Validated({ValidGroup.Update.class}) @RequestBody UmsMember data
    ) throws ModelException {
    ...
    public PagerData<UmsMember> list(
            @Parameter(description = "查询信息", name = "entityRequest")
            @Nullable @RequestBody UmsMemberRequest entityRequest
    ) throws ModelException {
